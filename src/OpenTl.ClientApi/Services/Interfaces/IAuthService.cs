namespace OpenTl.ClientApi.Services.Interfaces
{
    ...
    public interface IAuthService
    {
        ...
        /// <summary>
        /// Checks phone number is registered on server
        /// </summary>
        ...
        /// </summary>
        /// <param name="phoneNumber">Phone number</param>
        /// <param name="sentCode">The object <inheritdoc cref="ISentCode"/> obtained in the previous step <inheritdoc cref="SendCodeAsync"/>></param>
        ...
        /// <summary>
        /// Sends a cloud password if an exception <inheritdoc cref="CloudPasswordNeededException"/> is caught in the previous step <inheritdoc cref="SignInAsync"/>
        /// </summary>
